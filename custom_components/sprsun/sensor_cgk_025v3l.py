# custom_components/sprsun/sensor_cgk_025v3l.py
import logging
...
def _sensor_definitions_cgk_025v3l():
    sensors = []
    ...
    for name, value in globals().items():
        ...
        unique_id = f"cgk_025v3l_{clean_name}"
...
SENSORS_CGK_025V3L = _sensor_definitions_cgk_025v3l()
